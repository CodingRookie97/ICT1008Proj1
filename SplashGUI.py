...
class App(QWidget):
    ...
    def initUI(self):
        ...
        lblGrpInfo.move(230, 155)

        lblProjInfo = QLabel(self)
        lblProjInfo.setText('It\'s all about Punggol!')
